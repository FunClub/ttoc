...
local text2 = {
      ...
      {If = "SC:GetPlayer().Level >= 1 and SC:GetPlayer().Level < 80", End = '自定义打怪'},
            ...
            --打怪循环设置
            {AttackMonster = {25417} , Count = 1 ,  --0000,0000是要打的怪物id
            MoveTo = {
                  { { 4252.8379, 5799.2896, 67.0096 }, },
                  { { 4369.6162, 5773.4346, 77.3358}, },
    ...
    Config:Hide()
      ...
      SetSettings({
		...
		StuckEvent = true,
            ...
            --不贩卖列表 
            DoNotSellList = {'雪莲花','巫妖花','金苜蓿','蛇信草','冰棘草','塔兰德拉的玫瑰','卷丹','结晶','永恒','肉','钴矿石','符文法力药水','传送','Hearthstone','炉石','Skinning Knife','剥皮小刀','Mining Pick','矿工锄','Primal','源生','Mote of','微粒','Air','空气','基尔加丹印记',"Mark of Kil'jaeden","Thieves'Tools",'潜行者工具','Flash Powder','闪光粉'},
            --强制贩卖列表 如果需要可以自行添加
            --ForceSellList = {},
            --强制销毁
